                ...
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item btn btn-secondary mt-1">
                            <a class="nav-link" href="/frontend/views/reg_userSystem.html">
                                <!-- Icono de usuarios -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <li class="nav-item btn btn-secondary mt-1">
                            <a class="nav-link" href="/frontend/views/reportes.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <li class="nav-item btn btn-secondary mt-1">
                            <a class="nav-link" href="/ruta/a/cerrar_sesion.html">
                            ...
                            <div class="card card-gestion-usuarios">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <!-- Ejemplo de filas de usuarios con opciones para editar y eliminar -->
                                            <tr>
                                                <td>admin1</td>
                                                <td>Administrador</td>
                                                <td><button class="btn btn-sm btn-outline-secondary">Editar</button>
                                    ...
                                    <button class="btn btn-registrar-usuario btn-sm">Registrar Nuevo Usuario</button>
                                </div>
                            </div>
                        </div>
