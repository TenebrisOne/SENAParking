                ...
                <div class="sidebar-sticky"> <!-- Elemento que asegura que el sidebar se quede fijo cuando se hace scroll -->
                    <ul class="nav flex-column"> <!-- Lista de navegación -->
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="/frontend/views/dashboard_guardia.html">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/frontend/views/reg_userParking.html">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/frontend/views/reg_Accesos.html">
